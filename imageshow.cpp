...
void regret_imageshow(int x,int y)
{
	...
	{
		line(pixel_x, pixel_y - 25, pixel_x, pixel_y + 25);
		line(pixel_x, pixel_y, pixel_x + 25, pixel_y);
	}
	...
	{
		line(pixel_x, pixel_y - 25, pixel_x, pixel_y );
		line(pixel_x - 25, pixel_y, pixel_x + 25, pixel_y);
	}
	else if (pixel_y == Y&&pixel_x<MAX_X&&pixel_x>X)
	{
		line(pixel_x, pixel_y , pixel_x, pixel_y + 25);
		line(pixel_x - 25, pixel_y, pixel_x + 25, pixel_y);
	}
	...
	{
		line(pixel_x, pixel_y , pixel_x, pixel_y + 25);
		line(pixel_x - 25, pixel_y, pixel_x , pixel_y);
	}
